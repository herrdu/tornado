...
var initTradePage = function() {
    ...
    var dataTable = function() {
        var table = $('#tradelist'),
            oTable = table.dataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": Inter.getApiUrl().tradeRecordsQuery,
                    "type": "POST",
                    "data": function(d) {
                ...
                "columnDefs": [{
                    ...
                    "render": function(data, type, row) {
                        ...
                        return objBusiType[data];
                    }
                }, {
                    "targets": [6],
                    "render": function(data, type, row) {
                        var objStatus = com_Conf.getTradeStatus();
    ...
    var initTradeStatusSel = function() {
        ...
        //     placeholder: "请交易状态",
        //     allowClear: true,
        //     data: $.convertObjectToSelect2Array(com_Conf.getTradeStatus()),
        //     minimumResultsForSearch: Infinity, //没有选择框
        //     // escapeMarkup: function(markup) {
        //     //     return markup;
        //     // }, // let our custom formatter work
